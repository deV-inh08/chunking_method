...
export const REAL_LIFE_PRESETS = [
  ...
  },
  {
    ...
    userRole: 'Thực khách',
    defaultChunks: ['would like to', 'recommend something', 'keep an eye on'],
  ...
  },
  {
    ...
    userRole: 'Ứng viên',
    defaultChunks: ['in terms of', 'take responsibility for', 'come up with'],
  ...
  },
  {
    ...
    userRole: 'Hành khách',
    defaultChunks: ['heading towards', 'how long does it take', 'drop me off'],
  ...
  },
  {
    ...
    defaultChunks: ['suffer from', 'come down with', 'how often should I take'],
  ...
  },
  {
    ...
    defaultChunks: ['sign up for', 'work out', 'get in shape'],
